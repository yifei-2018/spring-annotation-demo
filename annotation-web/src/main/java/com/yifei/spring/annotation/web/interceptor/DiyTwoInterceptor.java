 ...
 * @date 2019/11/6
 */
@Component("diyTwoInterceptor")
public class DiyTwoInterceptor extends HandlerInterceptorAdapter {
    private static final Logger logger = LoggerFactory.getLogger(DiyTwoInterceptor.class);
    /**
     * 拦截器名称
     */
